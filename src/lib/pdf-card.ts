...
export async function generateWeddingCardPdf(params: CardPdfParams): Promise<Uint8Array> {
  ...
  const headline = sanitizeForPdf(params.headline || "Podziel się wspomnieniami!");
  const headSize = 12;
